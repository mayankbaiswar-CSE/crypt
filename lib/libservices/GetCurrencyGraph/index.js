import { currencyGraphBaseUrl } from "../BaseUrl"
...
class GetCurrencyGraph extends GETRequest {
    getUrl(props) {
        let urlBuilder = new UrlBuilder(currencyGraphBaseUrl)
            .addPath(props.id)
            .addPath(props.start)
            .addPath(props.end)
...
export default GetCurrencyGraph;